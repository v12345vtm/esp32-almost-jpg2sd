...
char lol[10];
void rewrite_string(); //function in CPP
...
//test functions to CPP file
   strcpy(lol, "Hello");
  Serial.println(lol); //lol = hello
  rewrite_string();//rewrite sting in CPP
  Serial.println(lol); // lol = world
  ...
  config.xclk_freq_hz = init_xclk_freq_hz;
